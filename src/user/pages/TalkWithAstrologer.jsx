...
// import profileImg from "../../assets/images/1638769877.png";
            ...
            <div className="row astrolger_baar desktop_view_astrologer_top">
              <div className="col-md-3 text-left">
                <ul id="breadcrumbs-two">
                  ...
                  <li>
                    <span className="current active text-capitalize">
      ...
      <div>
        ...
        <section className="why_astrology">
          <div className="container">
            ...
            <a href="mailto:mojoinnovative9@gmail.com" rel="noreferrer" target="_blank">
